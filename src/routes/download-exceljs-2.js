...
export async function exec(req, res) {
  ...
  this.logger.info('/download-exceljs-2 with PassThrough({ highWaterMark: 1024 }) start')
  ...
  this.logger.info(`/download-exceljs-2 end with duration: ${performance.now() - start}ms`)
}
